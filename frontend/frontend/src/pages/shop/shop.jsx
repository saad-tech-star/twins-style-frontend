...
const products = [
  // --- T-shirt ---
  { id: 1,  name: 't-shirt ', category: 'T-shirt',      price: 120, images: ['/images/produit1.jpg', '/images/backproduit1.jpg'] },
  { id: 2,  name: 't-shirt', category: 'T-shirt',      price: 120, images: ['/images/produit2.jpeg', '/images/backproduit2.jpeg'] },
  { id: 3,  name: 't-shirt', category: 'T-shirt',      price: 120, images: ['/images/produit3.jpeg', '/images/backproduit3.jpeg'] },
  { id: 4,  name: 't-shirt', category: 'T-shirt',      price: 120, images: ['/images/produit4.jpeg', '/images/backproduit4.jpeg'] },
  { id: 5,  name: 't-shirt', category: 'T-shirt',      price: 120, images: ['/images/produit5.jpeg', '/images/backproduit5.jpeg'] },
  { id: 6,  name: 't-shirt', category: 'T-shirt',      price: 120, images: ['/images/produit.jpg'] },

  // --- PANTALONS ---
  { id: 7,  name: 'jean baggy',    category: 'pantalons', price: 150, images: ['/images/jean1.jpg'] },
  { id: 8,  name: 'jean slim',    category: 'pantalons', price: 130, images: ['/images/jean2.jpg'] },
  { id: 9,  name: 'jean slim',    category: 'pantalons', price: 130, images: ['/images/jean3.jpg'] },

  // --- ROBES ---
  { id: 10, name: 'robe',    category: 'robes',     price: 130, images: ['/images/robe1.jpg'] },
  { id: 11, name: 'robe',    category: 'robes',     price: 130, images: ['/images/robe2.jpg'] },
  { id: 12, name: 'robe',    category: 'robes',     price: 180, images: ['/images/robe3.jpg'] },
]
